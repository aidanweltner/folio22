      ...
      typography: ({ theme }) => ({
        DEFAULT: {
          css: {
            ...
            '--tw-prose-invert-body': theme('colors.coffee[400]'),
            '--tw-prose-invert-headings': theme('colors.coffee[200]'),
            '--tw-prose-invert-lead': theme('colors.coffee[300]'),
            '--tw-prose-invert-links': theme('colors.coffee[300]'),
            '--tw-prose-invert-bold': theme('colors.coffee[300]'),
            ...
            '--tw-prose-invert-code': theme('colors.coffee[300]'),
            '--tw-prose-invert-pre-code': theme('colors.coffee[300]'),
            '--tw-prose-invert-pre-bg': theme('colors.coffee[800]'),
