...
return [
    ...
    */
    ...
    'feeds' => [
        'all' => [
            ...
            */
            'description' => 'Keep up with my photo galleries and a stream of personal posts that relate to any and everything that\'s interesting or that I\'ve recently learned',
    ...
    */
    ...
    'copyright' => 'Aidan Weltner 2015 - '.date('Y'),
